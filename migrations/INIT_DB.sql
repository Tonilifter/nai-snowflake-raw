...
CREATE SCHEMA IF NOT EXISTS ECI_INGESTION_TOOLS.DATA_CONTROL;
...
GRANT USAGE ON SCHEMA ECI_INGESTION_TOOLS.DATA_CONTROL TO ROLE &{ENV}_LND_NA_DEVELOPER_FR;
...
GRANT SELECT, INSERT ON ALL TABLES IN SCHEMA ECI_INGESTION_TOOLS.DATA_CONTROL TO ROLE &{ENV}_LND_NA_DEVELOPER_FR;

GRANT USAGE ON ALL PROCEDURES IN SCHEMA ECI_INGESTION_TOOLS.UTILS TO ROLE &{ENV}_LND_NA_DEVELOPER_FR;
GRANT USAGE ON ALL PROCEDURES IN SCHEMA ECI_INGESTION_TOOLS.STREAMING TO ROLE &{ENV}_LND_NA_DEVELOPER_FR;
GRANT USAGE ON ALL PROCEDURES IN SCHEMA ECI_INGESTION_TOOLS.BATCH TO ROLE &{ENV}_LND_NA_DEVELOPER_FR;
GRANT USAGE ON ALL PROCEDURES IN SCHEMA ECI_INGESTION_TOOLS.DATA_CONTROL TO ROLE &{ENV}_LND_NA_DEVELOPER_FR;