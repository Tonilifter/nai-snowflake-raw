...
begin
    ...
    fl_already_created_view := (select count(*) into :fl_already_created_view FROM identifier(:information_schema_views) where TABLE_CATALOG = :target_catalog and table_schema = :target_schema and TABLE_NAME = :target_view);
